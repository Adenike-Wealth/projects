void main(){
  ...
  int age = 35;
  int price = 400;
  print("Paul, a 35 years old, paid \$400 to repairs his father's car");
  print("Wealth's parent stays in Abuja");
  print('Wealth\s parent stays in China');
